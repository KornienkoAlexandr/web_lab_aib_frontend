...
import PostItem from "./Task_2_ItemsNew.jsx";
import PostForm from "./Task_3New.jsx";
import { Context } from "./context.jsx";
import PostTags from "./Tags.jsx";
const PostFour = () => {
  const [sortedPosts, setSortedPosts] = useState([{}]);
  const [posts, setPosts] = useState([
    { id: 1, username: "User", text: "text", tag: "#dogger", like: true },
    { id: 2, username: "User1", text: "text1", tag: "#dogger", like: false },
    { id: 3, username: "User2", text: "text2", tag: "#dogger", like: true },
    { id: 4, username: "User3", text: "text3", tag: "#dogger", like: false },
  ]);
